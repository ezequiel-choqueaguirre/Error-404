...
\photoR{2.5cm}{mifoto.png}
% \photoL{2cm}{Yacht_High,Suitcase_High}
\personalinfo{%
  % Not all of these are required!
  \email{ezequielchoqueaguirre@gmail.com}
  \phone{2612397548}
  \mailaddress{Las Heras,Argentina}
  \location{Mendoza}
...
\begin{itemize}
	\item \textbf{Guía Práctica de Métodos Numéricos con MATLAB}. (2025). \emph{Ediciones Universitarias de Cuyo}.
\end{itemize}
...
\cvevent{M.S.\ ingeniero Industrial}{Universidad Nacional de Cuyo}{Dec 1997 -- June 1999}{}

\divider

\cvevent{B.S.\ in Symbolic Systems}{Stanford University}{Sept 1998 -- June 1999}{}
